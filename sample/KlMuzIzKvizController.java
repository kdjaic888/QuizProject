...
public class KlMuzIzKvizController {
    ...
    static ArrayList<KlMuzIzKviz> questions;
    static int percent;
    static int pauseValue = 1500;

    @FXML
    void initialize() {
        questions = KlMuzIzKviz.loadQuestions("./Klasicnamuzikaiz.txt");

        KlMuzIzKviz.setButtons(button1, button2, button3, button4);

        questions.get(KlMuzIzKviz.getQuestionIndex()).displayQuestion(questionLabel, questionNum);
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        questions.get(KlMuzIzKviz.getQuestionIndex()).checkCorrect((Button) event.getTarget(), questions, scoreLabel);
    ...
    public static void finished(int score, int questionsCorrect) {
        ...
        finish.getDialogPane().getStylesheets().add(KlMuzIzKviz.class.getResource("lightTheme.css").toExternalForm());
        finish.showAndWait();
