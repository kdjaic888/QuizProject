...
public class GeoTNKvizController {
    ...
    static ArrayList<GeoTNKviz> questions;
    static int percent;
    ...
    void initialize() {
        ...
        questions = GeoTNKviz.loadQuestions("./Geografijatn.txt");

        GeoTNKviz.setButtons(button1, button2);

        questions.get(GeoTNKviz.getQuestionIndex()).displayQuestion(questionLabel, questionNum);
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        questions.get(GeoTNKviz.getQuestionIndex()).checkCorrect((Button) event.getTarget(), questions, scoreLabel);
    ...
    public static void finished(int score, int questionsCorrect) {
        ...
        finish.getDialogPane().getStylesheets().add(GeoTNKviz.class.getResource("lightTheme.css").toExternalForm());
        finish.showAndWait();
