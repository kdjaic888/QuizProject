...
public class HranaIzKvizController {
    ...
    static ArrayList<HranaIzKviz> questions;
    static int percent;
    static int pauseValue = 1500;

    @FXML
    void initialize() {
        questions = HranaIzKviz.loadQuestions("./Hranaiz.txt");

        HranaIzKviz.setButtons(button1, button2, button3, button4);

        questions.get(HranaIzKviz.getQuestionIndex()).displayQuestion(questionLabel, questionNum);
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        questions.get(HranaIzKviz.getQuestionIndex()).checkCorrect((Button) event.getTarget(), questions, scoreLabel);
    ...
    public static void finished(int score, int questionsCorrect) {
        ...
        finish.getDialogPane().getStylesheets().add(HranaIzKviz.class.getResource("lightTheme.css").toExternalForm());
        finish.showAndWait();
