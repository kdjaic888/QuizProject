...
public class PovijestIzKvizController {
    ...
    static ArrayList<PovijestIzKviz> questions;
    static int percent;
    ...
    void initialize() {
        ...
        questions = PovijestIzKviz.loadQuestions("./Povijestiz.txt");

        PovijestIzKviz.setButtons(button1, button2, button3, button4);

        questions.get(PovijestIzKviz.getQuestionIndex()).displayQuestion(questionLabel, questionNum);
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        questions.get(PovijestIzKviz.getQuestionIndex()).checkCorrect((Button) event.getTarget(), questions, scoreLabel);
    ...
    public static void finished(int score, int questionsCorrect) {
        ...
        finish.getDialogPane().getStylesheets().add(PovijestIzKviz.class.getResource("lightTheme.css").toExternalForm());
        finish.showAndWait();
